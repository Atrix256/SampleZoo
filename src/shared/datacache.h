...
struct DataCacheFamily
{
    ...
    void GetProgressiveSamples(const char* key, const SAMPLE_FN& SampleFn, std::vector<T>& values, size_t numValues, bool wantUnique)
    {
...
public:
    ...
    DataCacheFamily<float> m_samples_1d;
};