...
void _1d::Samples::IrrationalNumbers::GoldenRatioZero(std::vector<float>& values, size_t numValues)
{
...
void _1d::Samples::IrrationalNumbers::GoldenRatio(std::vector<float>& values, size_t numValues)
{
    values.resize(numValues);
    for (size_t i = 0; i < numValues; ++i)
...
void _1d::Samples::IrrationalNumbers::Pi(std::vector<float>& values, size_t numValues)
{
...
void _1d::Samples::IrrationalNumbers::Sqrt2(std::vector<float>& values, size_t numValues)
{
    // the part to the left of the decimal point doesn't matter for this, and just makes us hit precision problems sooner.
