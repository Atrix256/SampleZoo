...
void _1d::Samples::LDS::Sobol(std::vector<float>& values, size_t numValues, const char* cacheKey)
{
...
void _1d::Samples::LDS::VanDerCorput2(std::vector<float>& values, size_t numValues, const char* cacheKey)
{
    values.resize(numValues);
    VanDerCorput(values, 2);
}

void _1d::Samples::LDS::VanDerCorput3(std::vector<float>& values, size_t numValues, const char* cacheKey)
{
    values.resize(numValues);
    VanDerCorput(values, 3);
}

void _1d::Samples::LDS::VanDerCorput5(std::vector<float>& values, size_t numValues, const char* cacheKey)
{
    values.resize(numValues);
