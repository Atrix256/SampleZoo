 ...
 * samples.h is autogenerated
 * need to make samples/1d.h be autogenerated
 * need tests.h and tests/1d.h too
 * documentation later? maybe .md files with some standardized stuff, but custom text, links, papers, etc allowed per thing.
