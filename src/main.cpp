...
! continue the work in samplefamily.lua to autogen the autotest.h file, to follow the tests done above!
* make it spaces at home not tabs, in sublime. also show whitespace.

* auto gen test code & test results page from a info.lua file
* standardize the samplefamily.lua and info.lua files.
 * consistent naming convention
 * functions or table? if that should be standardized...
* we should probably forward declare std::vector instead of including it. who should include it then though? maybe it's ok and convinient?
* probably need to include "autotest.h" in the autogenerated sample headers.  Or maybe include it in eg regular.h as part of the header!
