...
void Tests::_1d::Discrepancy::CalculateDiscrepancy(SampleGenerateInfo_1d* sampleFunctions, size_t sampleFunctionCount,const char* testName)
{
    /*
...
void Tests::_1d::Discrepancy::CalculateDiscrepancyWrapAround(SampleGenerateInfo_1d* sampleFunctions, size_t sampleFunctionCount, const char* testName)
{
    /*
