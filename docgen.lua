...
for k,v in pairs(sampleFamilies) do
    ...
    for k2,v2 in pairs(subTestTypes) do
        ...
        file:write("Source Code: [source code](../../../../src/families/"..sampleFamily.."/tests/"..subTestType.."/)\n\n")
...
for k,v in pairs(sampleFamilies) do
    ...
    for k2,v2 in pairs(sampleTypes) do
        ...
        file:write("# "..sampleInfo.LongName.."\n")
        file:write("Source Code: [source code](../../../../src/families/"..sampleFamily.."/samples/"..sampleType.."/)\n\n")
        file:write(testsPage)
        file:write("\n")
        file:write(results)
        file:close()
